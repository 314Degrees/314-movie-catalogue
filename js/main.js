...
function cari(){
	...
	var url = `https://api.themoviedb.org/3/search/movie?api_key=5d4f79c774264736cfa7675c810a9a7c&query=${judulFilm}`;
	$.ajax({
		url: url,
		method: 'GET',
		dataType: 'JSONP',
...
function nowPlaying() {
	var nowPlayUrl = `https://api.themoviedb.org/3/movie/now_playing?api_key=5d4f79c774264736cfa7675c810a9a7c&language=en-US`;
	$.ajax({
		url: nowPlayUrl,
		method: 'GET',
		dataType: 'JSONP',
...
function upcoming() {
	var nowPlayUrl = `https://api.themoviedb.org/3/movie/upcoming?api_key=5d4f79c774264736cfa7675c810a9a7c&language=en-US`;
	$.ajax({
		url: nowPlayUrl,
		method: 'GET',
		dataType: 'JSONP',
